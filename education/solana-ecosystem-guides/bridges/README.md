# 🌉 Bridges on Solana — Connecting Ecosystems Safely

**Bridges on Solana** enable the movement of assets between Solana and other chains (WAX, EVM chains, etc.). While WAX has strong bridge support for Polygon, Base, and Ethereum, Solana bridges provide additional pathways for cross-chain experimentation. This is essential for future PxPortals integration and multi-chain strategies.

Bridges are powerful tools but also carry significant risks — always prioritize security and start small.

## Key Bridges Involving Solana

- **Official and Audited Bridges**: Use trusted bridges for moving assets between Solana and external ecosystems.
- **Cross-Chain Transfers**: Support for Solana ↔ EVM, Solana ↔ WAX, and other routes as they mature.
- **Security Focus**: Always prioritize audited, official bridges to minimize risks.

## Getting Started with Bridges on Solana
...
Bridges on Solana allow cost-effective testing of cross-chain mechanics that will become even more important with future PxPortals. Use them to move small amounts for experimentation, then apply lessons back to your core WAX/Pixel Journey activities. It’s another tool in the SVM toolkit that complements (never replaces) your primary focus on WAX collections and the PXJ economy.
