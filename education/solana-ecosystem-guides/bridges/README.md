...
Solana has strong bridge support to other chains (including EVM chains and others), which is relevant for future multi-chain expansion via PxPortals.

## Key Bridges from Solana

Solana has established bridges to various chains. These allow asset movement between ecosystems.
...
Bridges are a key part of the long-term vision for PxPortals and cross-chain experiences. Mastering bridging on Solana (in addition to WAX and other chains) allows you to safely explore other ecosystems while keeping your primary focus and capital on WAX collections, Pixals, and the PXJ economy. Skills gained here transfer directly to future multi-chain activities.
