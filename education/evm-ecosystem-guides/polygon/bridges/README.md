...
Polygon has strong bridge support to Ethereum mainnet and other chains, which is relevant for future multi-chain expansion via PxPortals.

## Key Bridges from Polygon

Polygon has established bridges to Ethereum mainnet and other supported chains. These allow asset movement between ecosystems.
...
Bridges are a key part of the long-term vision for PxPortals and cross-chain experiences. Mastering bridging on Polygon (in addition to WAX and other chains) allows you to safely explore multiple ecosystems while keeping your primary focus and capital on WAX collections, Pixals, and the PXJ economy. Skills gained here transfer directly to future multi-chain activities.
