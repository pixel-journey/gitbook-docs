# 🛡️ Security Tips for BNB Chain

> **⚠️ Critical Safety Reminder**  
> BNB Chain has a large and active ecosystem. Scams, phishing, and malicious contracts exist. Always stay vigilant. DYOR. Never share private keys or seed phrases.

Security practices on BNB Chain follow standard EVM principles with some chain-specific considerations.
...
- Large ecosystem with varying project quality — extra caution with new or low-liquidity projects is required.
- Bridge security is important when moving assets from Ethereum or WAX — use official/audited bridges.
- Many popular tools and explorers exist — stick to well-known, community-vetted ones.

## Pixel Journey Security Recommendations

When exploring BNB Chain alongside Pixel Journey:
...
- Use BNB Chain mainly for low-cost experimentation and learning.
