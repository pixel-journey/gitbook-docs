...
\
As always we do recommend you using [WaxOnEdge ](../waxonedge-routing-analytics/)for most optimal routing through all the Wax Ecosystem DEX/CEX', which also includes TacoSwap LPs. Using TaocSwap directly may lead to missed swap %s going to waste.
