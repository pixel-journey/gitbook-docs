---
description: >-
  Pixals currently have non-custodial staking via WaxDAO (for a bonus 1 PXJ an
  hour per Pixal PFP)
---
...
The current plan for Pixal PFPs is to let them stake at the current rates till the end of Season 1, after which it will be up to the [Rock Council](../the-rock-council.md) to allocate them PXJ to boost their WaxDAO Farm staking power if desired in the community.
