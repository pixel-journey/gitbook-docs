...
> **Feedback on swap UX, slippage handling, mobile experience, and yield-optimized routing is welcome** on Discord.

**PxSwap** is the high-performance decentralized exchange interface for the Pixel Journey ecosystem. It finds the best rates across multiple WAX DEXes and provides clean, fast tools for swapping tokens and managing liquidity — essential for active participation in staking, crafting, and the broader economy.
...
PxSwap plays an important supporting role:

- Enables efficient movement of capital between different parts of the Pixel Journey economy.
- Helps users take advantage of yield opportunities in PxStaking without friction.
- Supports liquidity on WAX DEXes, which benefits the entire ecosystem.
- Reduces the need to leave the Pixel Journey suite for basic trading needs.

## 🚀 What’s Coming Next

- More advanced order types (limit orders, stop-loss, DCA/recurring swaps)
- Better visualization of routing, price impact, and historical performance
- Deeper analytics on your LP positions and pool performance
